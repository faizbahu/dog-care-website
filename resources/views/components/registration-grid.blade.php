<div class="mx-auto flex flex-col items-center justify-center text-white lg:flex-row">
    <a class="group w-full lg:w-auto flex-1 cursor-pointer bg-yellow-300" href="{{ route('registration.permanent') }}">
    ...
    <a class="group w-full lg:w-auto flex-1 cursor-pointer bg-red-600" href="{{ route('registration.kennel') }}">
    ...
    <a class="group w-full lg:w-auto flex-1 cursor-pointer bg-blue-400" href="{{ route('registration.litter') }}">
        <div class="cards-section relative m-auto h-[560px] max-w-2xl py-10">
            <div id="headings" class="hover-effects ml-8 text-4xl font-bold lg:text-3xl">
                Litter Registration
            </div>
