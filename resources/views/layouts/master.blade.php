    ...
    <div class="container mx-auto">
                    ...
                    <ul class="flex space-x-10">
                        ...
                        <li class="group ">
                            <div class="py-1 inline-block relative mx-4">
                                <button class="font-medium nav-items inline-flex items-center rounded-lg text-center text-2xl">
                                    <span>Register</span>
                                ...
                                <ul class="z-10 mt-3 absolute hidden w-48 rounded-lg bg-white shadow group-hover:block">
                                    <li>
                                        <a class="px-3 py-2 block hover:text-[#832DB1] text-black text-sm"
                                           href="{{ route('registration.permanent') }}">Permanent Registration</a>
                                    </li>
                                    <li>
                                        <a class="px-3 py-2 block text-black text-sm hover:text-[#832DB1]" href="{{ route('registration.kennel') }}">Kennel
                                            Registration</a>
                                    </li>
                                    <li>
                                        <a class="px-3 py-2 block text-black text-sm hover:text-[#832DB1]" href="{{ route('registration.litter') }}">Litter
                                            Registration</a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="mobile-menu mt-8 ml-4 hidden h-52">
            <div class="flex flex-col space-y-5">
                ...
                <button id="" class="inline-flex items-center rounded-lg text-center text-2xl font-medium lg:px-4" type="button">Registration
                    <svg class="ml-2 h-4 w-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                         xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                ...
                <div id="" class="bg-white block rounded-lg shadow w-44 z-10">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="{{ route('registration.permanent') }}" class="block px-4 py-2 dark:hover:bg-gray-600 dark:hover:text-white">Permanent
                                Registration</a>
                        </li>
                        <li>
                            <a href="{{ route('registration.kennel') }}" class="block px-4 py-2 dark:hover:bg-gray-600 dark:hover:text-white">
                                Kennel Registration</a>
                        </li>
                        <li>
                            <a href="{{ route('registration.litter') }}" class="block px-4 py-2 dark:hover:bg-gray-600 dark:hover:text-white">
                                Litter Registration
                            </a>
                        </li>
                    </ul>
...
<footer class="bg-primary_gray">
    ...
    <div class="text-med mt-20 pb-5 text-center font-medium text-gray-400">© {{ date('Y') }} Bully Pedex All Rights Reserved.
    </div>
</footer>
<script>
